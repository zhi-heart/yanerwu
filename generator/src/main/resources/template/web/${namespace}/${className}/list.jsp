			...
			<div class="searchBar">
				<table class="searchContent">
					<tr>
						...
						<td>
							<#if column.remarks != ''>${column.remarks}<#else>${column.columnNameLower}</#if>: <input type="text" name="${column.columnNameLower}" class="<#if column.isDateTimeColumn>date<#else>textInput</#if>" <#if column.isDateTimeColumn>readonly="readonly"</#if> value="${r"$"}{query.${column.columnNameLower}}"/>
						</td>
						</#list>
					</tr>
				</table>
